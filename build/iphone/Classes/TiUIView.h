...
/**
 Base class for all SmartShopper views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SmartShopper view hierarchy (such as wrapped iOS UIViews) was touched.
