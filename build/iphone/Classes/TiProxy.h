...
//Rare exceptions to indicate a bug in the _smartshopper code (Eg, function that a subclass should have implemented)
...
/**
 The base class for SmartShopper proxies.
 */
