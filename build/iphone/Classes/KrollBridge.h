...
@interface SmartShopperObject : KrollCoverageObject {
#else
@interface SmartShopperObject : KrollObject {
#endif
@private
...
extern NSString * SmartShopper$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SmartShopperObject *_smartshopper;
    KrollObject* console;
	BOOL shutdown;
