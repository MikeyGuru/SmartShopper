...
// in simulator we redefine to format for SmartShopper Developer console
...
{\
	NSString * exceptionName = [@"org.smartshopper." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smartshopper";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISmartShopperNativeItemNone = -1, 
	UISmartShopperNativeItemSpinner = -2,
	UISmartShopperNativeItemProgressBar = -3,
	
	UISmartShopperNativeItemSlider = -4,
	UISmartShopperNativeItemSwitch = -5,
	UISmartShopperNativeItemMultiButton = -6,
	UISmartShopperNativeItemSegmented = -7,
	
	UISmartShopperNativeItemTextView = -8,
	UISmartShopperNativeItemTextField = -9,
	UISmartShopperNativeItemSearchBar = -10,
	
	UISmartShopperNativeItemPicker = -11,
	UISmartShopperNativeItemDatePicker = -12,
	
	UISmartShopperNativeItemInfoLight = -13,
	UISmartShopperNativeItemInfoDark = -14,
	
	UISmartShopperNativeItemDisclosure = -15,
	
	UISmartShopperNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SmartShopper instances of
