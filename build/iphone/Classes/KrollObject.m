...
//@interface SmartShopperObject : NSObject
//@end

@interface SmartShopperObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SmartShopperObject class]])
		{
			for (NSString *key in [[(SmartShopperObject*)o modules] allKeys])
			{
